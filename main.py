...
from stock_ai import load_tickers, fetch_market_prompt, analyze_with_gpt, analyze_multiple_with_gpt, add_to_history, update_history, fetch_financial_prompt, DATA_PATH, HISTORY_PATH, OUTPUT_DIR
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "/analyze_all ticker,ticker,ticker [YYYY-MM-DD] - проаналізувати всі тикери за дату (за замовчуванням сьогодні)"
    )
